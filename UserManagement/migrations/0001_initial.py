# Generated by Django 3.2.14 on 2022-08-23 08:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depart_title', models.CharField(max_length=32, verbose_name='部门标题')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ...
                ('depart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='UserManagement.departinfo')),
            ],
        ),
    ]
